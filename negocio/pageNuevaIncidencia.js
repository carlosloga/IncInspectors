...
function cargaAtributos(sIdItem, lv){
    ...
    aAtributos.forEach(function (objAtr) {
        sFila += "<tr><td style='text-align:right; font-size:x-small; width: 40%;'>" + objAtr.DESC + "</td>";
        sControl = "";
        switch(objAtr.TIPO)
        {
            case 'L' :
                    sControl = "<select id='select_" + objAtr.ID + "' name='select_" + objAtr.ID + "' data-mini='true' data-theme='d' style='width:99%;'>";
                    var sSelected = "";
            ...
            case 'T' :
                    sControl = "<input type='text' id='text_" + objAtr.ID + "' name='text_" + objAtr.ID + "' value='" + objAtr.DEF + "' data-mini='true' data-theme='d' style='width:99%;'></input>";
                 break;

            case 'N' :
                sControl = "<input type='number' id='text_" + objAtr.ID + "' name='text_" + objAtr.ID + "' value='" + objAtr.DEF + "' data-mini='true' data-theme='d' style='width:99%;'></input>";
                break;

            case 'F' :
                sControl = "<input type='datetime' id='text_" + objAtr.ID + "' name='text_" + objAtr.ID + "' value='" + objAtr.DEF + "' data-mini='true' data-theme='d' style='width:99%;'></input>";
                break;
        }
